...
c           in list 2
c
c      bh2dterms_list2w - build the number of terms table for all boxes 
c           in list 2, worst case error in multipole to local translation 
c
c      bh2dterms_list2ew - build the number of terms table for all boxes
...
c
c
      subroutine bh2dterms_list2w(eps, itable, ier)
      implicit real *8 (a-h,o-z)
c
c
c     Determine number of terms in mpole expansions for box of size
...
c
c
      subroutine bh2dterms_list2e(eps, itable, ier)
      implicit real *8 (a-h,o-z)
c
c
c     Determine number of terms in mpole expansions for box of size
...
c
c
      subroutine bh2dterms_list2ew(eps, itable, ier)
      implicit real *8 (a-h,o-z)
c
c
c     Determine number of terms in mpole expansions for box of size
...
c
c
      subroutine bh2dterms_eval(itype, eps, nterms, ier)
      implicit real *8 (a-h,o-z)
c
c
c     Determine number of terms in mpole expansions for box of size
