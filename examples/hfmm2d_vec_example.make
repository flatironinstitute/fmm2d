...
PROJECT = int2-hfmm2d-vec-example
...
# the cross compiled libraries. See fmm2d.readthedocs.io/install.html
# for additional info
...
OBJECTS = hfmm2d_vec_example.o \
    ../src/Common/hkrand.o \
    ../src/Common/dlaran.o 

all: $(OBJECTS) 
	$(FC) $(FFLAGS)  -o $(PROJECT) $(OBJECTS) -lfmm2d 
	./$(PROJECT)
