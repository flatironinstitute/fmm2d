...
%  -  U.hesstarg: hessian at target locations, if requested, $\nabla \nabla u(t_{i})$
  ...
  if(pgt == 1)
    if(ifcharge==1 && ifdipole == 0)
      mex_id_ = 'r2d_directcp(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i int[x], io double[xx], i double[x])';
[pottarg] = fmm2d(mex_id_, nd, sources, ns, charges, targ, nt, pottarg, thresh, 1, 2, ns, 1, nd, ns, 2, nt, 1, nd, nt, 1);
    end
    if(ifcharge==0 && ifdipole == 1)
      mex_id_ = 'r2d_directdp(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i double[xx], i int[x], io double[xx], i double[x])';
[pottarg] = fmm2d(mex_id_, nd, sources, ns, dipstr, dipvec, targ, nt, pottarg, thresh, 1, 2, ns, 1, nd, ns, nd2, ns, 2, nt, 1, nd, nt, 1);
    ...
    if(ifcharge==1 && ifdipole == 1)
      mex_id_ = 'r2d_directcdp(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i double[xx], i double[xx], i int[x], io double[xx], i double[x])';
[pottarg] = fmm2d(mex_id_, nd, sources, ns, charges, dipstr, dipvec, targ, nt, pottarg, thresh, 1, 2, ns, 1, nd, ns, nd, ns, nd2, ns, 2, nt, 1, nd, nt, 1);
  ...
  if(pgt == 2)
    if(ifcharge==1 && ifdipole == 0)
      mex_id_ = 'r2d_directcg(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i int[x], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg] = fmm2d(mex_id_, nd, sources, ns, charges, targ, nt, pottarg, gradtarg, thresh, 1, 2, ns, 1, nd, ns, 2, nt, 1, nd, nt, nd2, nt, 1);
    ...
    if(ifcharge==0 && ifdipole == 1)
      mex_id_ = 'r2d_directdg(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i double[xx], i int[x], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg] = fmm2d(mex_id_, nd, sources, ns, dipstr, dipvec, targ, nt, pottarg, gradtarg, thresh, 1, 2, ns, 1, nd, ns, nd2, ns, 2, nt, 1, nd, nt, nd2, nt, 1);
    ...
    if(ifcharge==1 && ifdipole == 1)
      mex_id_ = 'r2d_directcdg(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i double[xx], i double[xx], i int[x], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg] = fmm2d(mex_id_, nd, sources, ns, charges, dipstr, dipvec, targ, nt, pottarg, gradtarg, thresh, 1, 2, ns, 1, nd, ns, nd, ns, nd2, ns, 2, nt, 1, nd, nt, nd2, nt, 1);
  ...
  if(pgt == 3)
    if(ifcharge==1 && ifdipole == 0)
      mex_id_ = 'r2d_directch(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i int[x], io double[xx], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg, hesstarg] = fmm2d(mex_id_, nd, sources, ns, charges, targ, nt, pottarg, gradtarg, hesstarg, thresh, 1, 2, ns, 1, nd, ns, 2, nt, 1, nd, nt, nd2, nt, nd3, nt, 1);
    ...
    if(ifcharge==0 && ifdipole == 1)
      mex_id_ = 'r2d_directdh(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i double[xx], i int[x], io double[xx], io double[xx], io double[xx], i double[x])';
[pottarg, gradtarg, hesstarg] = fmm2d(mex_id_, nd, sources, ns, dipstr, dipvec, targ, nt, pottarg, gradtarg, hesstarg, thresh, 1, 2, ns, 1, nd, ns, nd2, ns, 2, nt, 1, nd, nt, nd2, nt, nd3, nt, 1);
    ...
    if(ifcharge==1 && ifdipole == 1)
      mex_id_ = 'r2d_directcdh(i int[x], i double[xx], i int[x], i double[xx], i double[xx], i double[xx], i double[xx], i int[x], io double[xx], io double[xx], io double[xx], i double[x])';
