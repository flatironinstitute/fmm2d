...
c      
c**********************************************************************
      subroutine l2d_directcp(nd,sources,ns,charge,
     $           targ,nt,pot,thresh)
cf2py  intent(in) nd
...
c
c**********************************************************************
      subroutine l2d_directcg(nd,sources,ns,charge,targ,nt,pot,
     1             grad,thresh)
cf2py  intent(in) nd
cf2py  intent(in) sources,ns,charge,targ,nt,thresh
...
c
c**********************************************************************
      subroutine l2d_directch(nd,sources,ns,charge,targ,nt,
...
c
c**********************************************************************
      subroutine l2d_directdp(nd,sources,ns,dipstr,dipvec,
     $           targ,nt,pot,thresh)
cf2py  intent(in) nd
cf2py  intent(in) sources,ns,dipstr,dipvec,targ,nt,thresh
cf2py  intent(out) pot
      implicit none
c**********************************************************************
c
...
c     response: i.e., log|z|
c     
c     pot(ii,i)  = \sum_j dipstr(ii,j)* dipvec(ii,:,j) \cdot
...
c
c**********************************************************************
      subroutine l2d_directdg(nd,sources,ns,dipstr,dipvec,targ,nt,pot,
     1             grad,thresh)
cf2py  intent(in) nd
cf2py  intent(in) sources,ns,dipstr,dipvec,targ,nt,thresh
cf2py  intent(out) pot,grad
...
c
c**********************************************************************
      subroutine l2d_directdh(nd,sources,ns,dipstr,dipvec,targ,nt,
     1           pot,grad,hess,thresh)
cf2py  intent(in) nd
cf2py  intent(in) sources,ns,dipstr,dipvec,targ,nt,thresh
cf2py  intent(out) pot,grad,hess
...
c
c**********************************************************************
      subroutine l2d_directcdp(nd,sources,ns,charge,
     $           dipstr,dipvec,targ,nt,pot,thresh)
cf2py  intent(in) nd
cf2py  intent(in) sources,ns,charge,dipstr,dipvec,targ,nt,thresh
cf2py  intent(out) pot
      implicit none
c**********************************************************************
c
...
c
c**********************************************************************
      subroutine l2d_directcdg(nd,sources,ns,charge,dipstr,dipvec,
...
c
c**********************************************************************
      subroutine l2d_directcdh(nd,sources,ns,charge,dipstr,dipvec,
