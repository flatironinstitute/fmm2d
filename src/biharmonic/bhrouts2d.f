...
c
c     bh2dformmpc_vec: creates multipole expansion (outgoing) due to 
c                     a collection of charge sources
c     bh2dformmpd_vec: creates multipole expansion (outgoing) due to 
c                     a collection of dipole sources
c     bh2dformmpcd_vec: creates multipole expansion (outgoing) due to 
c                     a collection of charge and dipole sources
c     bh2dformta_vec: creates local expansion (incoming) due to 
c                     a collection of charge sources
c     bh2dformtad_vec: creates multipole expansion (incoming) due to 
c                     a collection of dipole sources
c     bh2dformtacd_vec: creates multipole expansion (incoming) due to 
c                     a collection of charge and dipole sources
c
c------------------------------------------------------------------     
c     Multipole and local translation operators
c
c     bh2dmpmp_vec: Converts multipole expansion to a multipole expansion
c     bh2dmploc_vec: Converts multipole expansion to local expansion
c     bh2dlocloc_vec: converts local expansion to local expansion
c
c---------------------------------------------------------------------
c     Evaluation subroutines
c 
c     bh2dmpevalp_vec: Computes the complex velocity due to a 
c                      multipole expansion at a collection of targets
c     bh2dmpevalg_vec: Computes the complex velocity and its gradients 
c                      due to a multipole expansion at a collection 
c                      of targets
c     bh2dtaevalp_vec: Computes the complex velocity due to a 
c                      local expansion at a collection of targets
c     bh2dtaevalg_vec: Computes the complex velocity and its gradients 
c                      due to a local expansion at a collection 
c                      of targets
c----------------------------------------------------------------------
c     Utility subroutines
c     
c     bh2dzero_vec: utility to intialize multipole/local coefficients to
c                   zero
c    
c*********************************************************************
c
