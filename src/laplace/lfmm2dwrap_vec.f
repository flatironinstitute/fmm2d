...
c
      ...
      subroutine lfmm2d_s_c_p_vec(nd,eps,ns,sources,
     1            charge,pot,ier)
...
c------------------------------
      ...
      subroutine lfmm2d_s_c_g_vec(nd,eps,ns,sources,
...
c
      ...
      complex *16 hess(nd,3),hesstarg(nd,3)
      real *8 targ(2)
      complex *16 pottarg(nd,1),gradtarg(nd,2,1)
      integer nt
      integer ifcharge,ifdipole,iper
      integer ifpgh,ifpghtarg
...
c
c
      subroutine lfmm2d_s_c_h_vec(nd,eps,ns,sources,
...
c
      ...
      real *8 dipvec(nd,2)
      real *8 targ(2)
      complex *16 pottarg(nd,1),gradtarg(nd,2,1),hesstarg(nd,3,1)
      integer nt
      integer ifcharge,ifdipole,iper
      integer ifpgh,ifpghtarg
...
c-------------------------------      
      ...
      subroutine lfmm2d_s_d_p_vec(nd,eps,ns,sources,
...
c------------------------------
      ...
      subroutine lfmm2d_s_d_g_vec(nd,eps,ns,sources,
...
c
c
      subroutine lfmm2d_s_d_h_vec(nd,eps,ns,sources,
...
c-------------------------------      
      ...
      subroutine lfmm2d_s_cd_p_vec(nd,eps,ns,sources,charge,
     1            dipstr,dipvec,pot,ier)
cf2py  intent(in) eps,nd
...
c------------------------------
      ...
      subroutine lfmm2d_s_cd_g_vec(nd,eps,ns,sources,charge,
     1            dipstr,dipvec,pot,grad,ier)
cf2py  intent(in) eps,nd
cf2py  intent(in) ns,sources,charge,dipstr,dipvec
cf2py  intent(out) pot,grad,ier
...
c
c
      subroutine lfmm2d_s_cd_h_vec(nd,eps,ns,sources,charge,
     1            dipstr,dipvec,pot,grad,hess,ier)
cf2py  intent(in) eps,nd
cf2py  intent(in) ns,sources,charge,dipstr,dipvec
cf2py  intent(out) pot,grad,hess,ier
...
c
c      
      subroutine lfmm2d_t_c_p_vec(nd,eps,ns,sources,
...
c------------------------------
      ...
      subroutine lfmm2d_t_c_g_vec(nd,eps,ns,sources,
...
c
c
      subroutine lfmm2d_t_c_h_vec(nd,eps,ns,sources,
...
c-------------------------------      
      ...
      subroutine lfmm2d_t_d_p_vec(nd,eps,ns,sources,
...
c------------------------------
      ...
      subroutine lfmm2d_t_d_g_vec(nd,eps,ns,sources,
...
c
c
      subroutine lfmm2d_t_d_h_vec(nd,eps,ns,sources,
...
c-------------------------------      
      ...
      subroutine lfmm2d_t_cd_p_vec(nd,eps,ns,sources,charge,
     1            dipstr,dipvec,nt,targ,pottarg,ier)
cf2py  intent(in) eps,nd
...
c------------------------------
      ...
      subroutine lfmm2d_t_cd_g_vec(nd,eps,ns,sources,charge,
     1            dipstr,dipvec,nt,targ,pottarg,gradtarg,ier)
cf2py  intent(in) eps,nd
cf2py  intent(in) ns,sources,charge,dipstr,dipvec,nt,targ
cf2py  intent(out) pottarg,gradtarg,ier
...
c
c
      subroutine lfmm2d_t_cd_h_vec(nd,eps,ns,sources,charge,
     1            dipstr,dipvec,nt,targ,pottarg,
     2            gradtarg,hesstarg,ier)
cf2py  intent(in) eps,nd
cf2py  intent(in) ns,sources,charge,dipstr,dipvec,nt,targ
